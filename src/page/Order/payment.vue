    ...
    <y-shelf title="支付订单">
      <div slot="content">
        ...
        <div class="pay-type">
          ...
          <div class="pay-item">
            <div :class="{active:payType==1}" @click="payType=1"><img src="/static/images/hdfk.png" alt=""></div>
          <!--
      ...
      paySuc () {
        ...
        payMent({
          ...
          if (res.success === true) {
            ...
            if (this.payType === 1) {
              this.$router.push({path: '/order/alipay?orderId=' + vm.orderId})
            } else if (this.payType === 2) {
              this.$router.push({path: '/order/wechat?orderId=' + vm.orderId})
            } else if (this.payType === 3) {
              this.$router.push({path: '/order/qqpay?orderId=' + vm.orderId})
            } else {
              this.$router.push({path: '/order/alipay?orderId=' + vm.orderId})
            }
          } else {
