<template>
  <div class="login v2">
    <div class="wrapper">
        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            ...
            <el-checkbox class="agree" v-model="agreement">
              我已阅读并同意遵守
              <a href="/static/html/register_protocol.html" target="_blank">注册协议</a> 和
              <a href="/static/html/privacy_policy.html" target="_blank">隐私条款</a>
            </el-checkbox>
      ...
      <y-footer style="position:absolute; bottom:-200px; width: 100%; flex-direction: column;"></y-footer>
    </div>
  </div>
</template>
<script>
