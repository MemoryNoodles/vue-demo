<template>
  <div class="login v2">
        ...
        <div v-if="loginPage" class="content">
          <ul class="common-form">
            ...
            <li style="text-align: right" class="pr">
              ...
              <a href="javascript:;" class="register" @click="toRegister">注册 下单购 账号</a>
              <a style="padding: 1px 0 0 10px" @click="open('找回密码','找回密码请关注下单购微信公总号，联系客服进行修改')">忘记密码 ?</a>
            </li>
          </ul>
          <!--登陆-->
          ...
          <!--返回-->
          <div>
            <y-button text="返回首页" @btnClick="login_back"
    ...
    <y-footer style="position:absolute; bottom:-300px; width: 100%; flex-direction: column;"></y-footer>
  </div>
</template>
<script>
